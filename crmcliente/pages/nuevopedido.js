...
const NuevoPedido = () => {
   ...
   // Utilizar context y extraer sus valores
    ...
    const [ nuevoPedido ] = useMutation(NUEVO_PEDIDO)
        ...
        const validarPedido = () =>{
              return !productos.every( producto => producto.cantidad > 0 ) || total === 0 || cliente.length === 0 ?  'opactity-50 cursor-not-allowed' : ''
        }
    ...
    return(
        <Layout>
<h1 className="text-2xl text-gray-800 font-light">Crear nuevos pedidos</h1>
